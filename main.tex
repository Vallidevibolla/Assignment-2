...
\begin{lstlisting}
https://github.com/ka-raja-babu/Matrix-Theory/tree/main/Assignment1/Codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/ka-raja-babu/Matrix-Theory/tree/main/Assignment1
\end{lstlisting}
%
\section{Question No.2.18}

Consider the collision depicted in Fig. 2.18 to be between two billiard balls with equal masses m1=m2. The first ball is called the cue while the second ball is called the target. The billiard player wants to 'sink' the target ball in a corner pocket, which is at angle $\o$ = 37\degree. Assume that the collision is elastic and that friction and rotational motion are not important. Obtain $\theta$.
...
\begin{align}
    \boxed{m1u1+m2u2=m1v1+m2v2}  \\
since (u2=0), also ( m1=m2=m )\\
    \boxed{u1=v1+v2} 
\end{align}    
The energy of two balls after collision is given by Kinetic energy.
\textbf{K.E} =$\frac{1}{2}$m v^2 \\
 
$\frac{1}{2}$mu1^2 = $\frac{1}{2}$mv1^2 + $\frac{1}{2}$mv2^2

\begin{align}
    \boxed{u1^2 = v1^2 + v2^2} \\
   \implies(v1+v2)^2 = v1^2+v2^2\\
   \implies v1^2+v2^2+2v1v2 = v1^2+v2^2\\
   \implies2v1v2=0\\
   \implies v_1.v_2=0
\end{align}

since \cos{90\degree}=0\\
\implies v_1.v_2(\cos{\Phi})=\cos{90\degree}\\
Given, \Phi=37\degree
